...
/*!************************************************************!*\
  !*** external "app1@http://localhost:8500/remoteEntry.js" ***!
  \************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
let app1 = __webpack_require__.e(/*! import() */ "webpack_container_remote_app1_App").then(__webpack_require__.t.bind(__webpack_require__, /*! app1/App */ "webpack/container/remote/app1/App", 23));
...
promise.then(res => {
  ...
  console.log(res);
  const root = react__WEBPACK_IMPORTED_MODULE_0___default().createRoot(document.getElementById('root'));
  root.render(res);
});
console.log(promise);
})();
